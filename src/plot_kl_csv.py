...
if __name__=='__main__':
    ...
    steps1, value1, original_value1 = smooth('tensorboard_data/run-visiual-tag-loss_approximate_kullback-leibler.csv')
    steps2, value2, original_value2 = smooth('tensorboard_data/run-force-tag-loss_approximate_kullback-leibler.csv')
    steps3, value3, original_value3 = smooth('tensorboard_data/run-pre-tag-loss_approximate_kullback-leibler.csv')
    steps4, value4, original_value4 = smooth('tensorboard_data/run-full-tag-loss_approximate_kullback-leibler.csv')
