...
class TactileTableTask(Task):
    """
    Creates MJCF model of a tactile table task.

    A tactile table task consists of one robot interacting with table with
    tactile sensors. This class combines the robot, the tactile table
