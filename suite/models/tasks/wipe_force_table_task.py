from suite.models.tasks import Task, UniformRandomSampler
from suite.utils.mjcf_utils import new_joint, array_to_string


class WipeForceTableTask(Task):
    """
    Creates MJCF model of a wipe_force table task.

    A wipe_force table task consists of one robot interacting with table with
    wipe_force sensors. This class combines the robot, the wipe_force table
