from suite.models.objects import MujocoXMLObject
...
class PlateWithRoundHoleObject(MujocoXMLObject):

    def __init__(self):
        super().__init__(xml_path_completion("objects/plate-with-round-hole.xml"))